            ...
            <div class="container">
                <div class="header-middle-left">
                    <div class="header-logo">
                        <a href="">
                            <img src="./assets/img/binhfood.png" alt="" class="header-logo-img">
                        </a>
                    </div>
                </div>
    ...
    <nav class="header-bottom">
        <div class="container">
            <ul class="menu-list">
                ...
                <li class="menu-list-item" onclick="showCategory('Món chay')"><a href="javascript:;"
                        class="menu-link">Món chay</a></li>
                <li class="menu-list-item" onclick="showCategory('Món mặn')"><a href="javascript:;"
                        class="menu-link">Món mặn</a></li>
                <li class="menu-list-item" onclick="showCategory('Món lẩu')"><a href="javascript:;"
                        class="menu-link">Món lẩu</a></li>
                <li class="menu-list-item" onclick="showCategory('Món ăn vặt')"><a href="javascript:;"
                        class="menu-link">Món ăn vặt</a></li>
                <li class="menu-list-item" onclick="showCategory('Món tráng miệng')"><a href="javascript:;"
                        class="menu-link">Món tráng miệng</a></li>
                <li class="menu-list-item" onclick="showCategory('Nước uống')"><a href="javascript:;"
                        class="menu-link">Nước uống</a></li>
                <li class="menu-list-item" onclick="showCategory('Món khác')"><a href="javascript:;"
                        class="menu-link">Món khác</a></li>
            </ul>
        </div>
    </nav>
                ...
                <div class="form-content sign-up">
                    ...
                    <form action="" class="signup-form">
                        <div class="form-group">
                            ...
                            <input id="username" name="username" type="text" placeholder="Nhập họ và tên "
                                class="form-control">
            ...
            <div class="footer-top">
                <div class="footer-top-content">
                    <div class="footer-top-img">
                        <img src="./assets/img/Binhfood-logo.png" alt="">
                    </div>
                ...
                <div class="widget-row">
                    <div class="widget-row-col-1">
                        ...
                        <div class="widget-row-col-content">
                            <p>BinhFood là thương hiệu được thành lập vào năm 2025 với tiêu chí đặt chất lượng sản phẩm
                                lên hàng đầu.</p>
                        </div>
                    ...
                    <div class="widget-row-col">
                        ...
                        <ul class="widget-contact">
                            <li class="widget-contact-item" onclick="showCategory('Món ăn vặt')">
                                <a href="javascript:;">
                                    <i class="fa-regular fa-arrow-right"></i>
                                    <span>Món ăn vặt</span>
                                </a>
                            </li>
                            <li class="widget-contact-item" onclick="showCategory('Món chay')">
                                <a href="javascript:;">
                                    <i class="fa-regular fa-arrow-right"></i>
                                    <span>Món chay</span>
                                </a>
                            </li>
                            <li class="widget-contact-item" onclick="showCategory('Món mặn')">
                                <a href="javascript:;">
                                    <i class="fa-regular fa-arrow-right"></i>
                                    <span>Món mặn</span>
                                </a>
                            </li>
                            <li class="widget-contact-item" onclick="showCategory('Nước uống')">
                                <a href="javascript:;">
                                    <i class="fa-regular fa-arrow-right"></i>
                                    <span>Nước uống</span>
                                </a>
                            </li>
                            <li class="widget-contact-item" onclick="showCategory('Món tráng miệng')">
                                <a href="javascript:;">
                                    <i class="fa-regular fa-arrow-right"></i>
          ...
          <div class="checkout-col-left">
            <div class="checkout-row">
              ...
              <div class="checkout-col-content">
                ...
                <div class="content-group chk-ship delivery-time-section">
                  <p class="checkout-content-label">Thời gian giao hàng</p>
                  <div class="delivery-time">
                    <input type="radio" name="delivery" id="giaongay" class="radio">
                    <label for="giaongay">Giao ngay khi xong</label>
                  </div>
                  <div class="delivery-time">
                    <input type="radio" name="delivery" id="deliverytime" class="radio">
                ...
                <div class="content-group" id="tudenlay-group" style="display: none;">
                  <p class="checkout-content-label">Lấy hàng tại chi nhánh</p>
                  <div class="delivery-time">
                    <input type="radio" name="chinhanh" id="chinhanh-1" class="radio">
                    <label for="chinhanh-1">123 Nguyễn Trãi, Thanh Xuân, Hà Nội</label>
                  </div>
                  <div class="delivery-time">
                    <input type="radio" name="chinhanh" id="chinhanh-2" class="radio">
                    <label for="chinhanh-2">494 Giải Phóng, Hai Bà Trưng, Hà Nội</label>
                  </div>
                </div>
      
                <div class="content-group pickup-time-section" style="display: none;">
                  <p class="checkout-content-label">Thời gian lấy hàng</p>
                  <div class="delivery-time">
                    <input type="radio" name="pickuptime" id="pickuptime-now" class="radio">
                    <label for="pickuptime-now">Lấy ngay khi xong</label>
                  </div>
                  <div class="delivery-time">
                    <input type="radio" name="pickuptime" id="pickuptime-schedule" class="radio">
                    <label for="pickuptime-schedule">Lấy vào giờ</label>
                    <select class="pickup-choise-time">
                      <option value="08:00">08:00</option>
                      <option value="08:30">08:30</option>
                      <option value="09:00">09:00</option>
                      <option value="09:30">09:30</option>
                ...
                <div class="content-group">
                  ...
                  <textarea class="note-order" placeholder="Nhập ghi chú"></textarea>
                </div>
              </div>
            </div>
              ...
              <div class="checkout-col-content">
                <div class="content-group">
                  <form class="info-nhan-hang">
                    ...
                    <div class="form-group">
                      <input id="sdtnhan" name="sdtnhan" type="text"
                             placeholder="Số điện thoại nhận hàng" class="form-control">
                      <span class="form-message"></span>
                    </div>
                    <div class="form-group">
                      <input id="diachinhan" name="diachinhan" type="text"
          ...
          <div class="checkout-col-right">
            ...
            <div class="bill-payment">
              ...
              <div class="policy-note">
                ...
                <a href="#" target="_blank">chính sách hoạt động</a> của chúng tôi.
              </div>
            </div>
